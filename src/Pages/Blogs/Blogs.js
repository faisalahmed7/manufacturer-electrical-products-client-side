    ...
    return (
        <div>
            ...
            <div className='text-center px-2'>
                <h5 className='text-4xl text-secondary mb-4 text-justify mt-4'> 1. How does prototypical inheritance work?</h5>
            ...
            <div className='text-center px-2'>
                <h5 className='text-4xl text-secondary mb-4 text-justify mt-4'> 2. What are the different ways to manage a state in a React application?</h5>
            ...
            <div className='text-center px-2'>
                <h5 className='text-4xl text-secondary mb-4 text-justify mt-4'> 3. How will you improve the performance of a React Application?</h5>
            ...
            <div className='text-center px-2'>
                <h5 className='text-4xl text-secondary mb-4 text-justify mt-4'>4.  Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h5>
            ...
            <div className='text-center px-2'>
                <h5 className='text-4xl text-secondary mb-4 text-justify mt-4'>5. What is a unit test? Why should write unit tests?</h5>
