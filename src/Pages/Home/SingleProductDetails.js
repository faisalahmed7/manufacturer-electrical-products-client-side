    ...
    return (
        <div className="card lg:max-w-lg bg-base-100 shadow-xl  m-auto">
            ...
            <div className="card-body items-center text-center">
                ...
                <p><span className='text-xl text-bold font-bold text-red-500'>Available Quantity:</span> <span className='italic'> {quantity} pcs</span></p>
                <p><span className='text-xl text-bold font-bold text-red-500'>Price:</span> <span className='italic'> {price} BDT/unit</span>  </p>
                <p><span className='text-xl text-bold font-bold text-red-500'>Minimum Order Quantity:</span> <span className='italic'> {minQuantity} pcs</span></p>
